...
inpTweets = csv.reader(open('min3.csv',encoding='latin1'), delimiter=',', quotechar='|')
...
#testTweet = 'Congrats for winning the championship'
#processedTestTweet = processTweet(testTweet)

accuracy=nltk.classify.accuracy(MaxEntClassifier, training_set)
